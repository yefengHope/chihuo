...
/**
 * Created by HanFeng on 2017/7/5.
 */
@Configuration
...
public class MybatisAutoConfiguration {
    ...
    private static Logger loggger = LoggerFactory.getLogger(MybatisAutoConfiguration.class);
    ...
    public PageHelper pageHelper(DataSource dataSource) {
        loggger.info("注册MyBatis分页插件PageHelper");
