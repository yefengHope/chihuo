...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            ...
            <#if menus??>
                <#list menus as tree><#--遍历顶级菜单-->
                    <#if (tree.id) == '2'><#--只遍历后台部分菜单-->
                        <#if  (tree.children)?? && (tree.children?size > 0)> <#--如果顶级菜单（即二级菜单）存在-->
                        <#--  ***目标工作为显示二级菜单 start***  -->
                            <#list tree.children as subTree><#--遍历二级菜单-->
                                <li><#--显示的一级菜单 start-->
                                    ...
                                    <#if (subTree.children)?? && (subTree.children?size > 0) > <#--如果二级菜单存在子菜单（即三级菜单,显示的二级菜单）-->
                                        ...
                                        <#--循环二级显示菜单 start-->
                                            <#list subTree.children as twoShowTree>
                                                <li>
                                                <#--判断是否有三级菜单，因为显示样式不一样-->
