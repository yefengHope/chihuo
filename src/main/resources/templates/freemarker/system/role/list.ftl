                ...
                <div class="btn-group hidden-xs" id="bootTableSearch" role="group">
                    <button type="button" class="btn btn-outline btn-default">
                        <i class="glyphicon glyphicon-plus" aria-hidden="true"
                           onclick="BootstrapTableFunc.toAddForm('/admin/role/to_add.htm','','新增角色',null)">新增</i>
                    </button>
                    <button type="button" class="btn btn-outline btn-default">
                        <i class="glyphicon glyphicon-edit" aria-hidden="true"
                           onclick="BootstrapTableFunc.toEditForm('#bootTable','/admin/role/to_update.htm','','编辑角色')">编辑</i>
                    </button>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="javascript:void"
                                   onclick="BootstrapTableFunc.delRowsData('#bootTable','/admin/role/del_rows.htm')">删除</a>
                            <#--<li class="divider"></li>-->
                            </li>
                        </ul>
                    </div>
...
<script src="/js/system/role/list.js"></script>
</body>
</html>